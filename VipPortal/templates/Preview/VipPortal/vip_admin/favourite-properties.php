...
<?= $this->Html->css('/vip_portal/css/vip_admin/tw-favourite-properties'); ?>
...
<script>
    ...
    function addClassToCircleIndicator() {
        document.getElementById("circle_indicator_favourites").classList.add("circle_indicator_active");
    }
