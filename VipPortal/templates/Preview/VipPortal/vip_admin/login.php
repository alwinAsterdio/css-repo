...
<?= $this->Html->css('/vip_portal/css/vip_admin/tw-login'); ?>
<style>
    .message.error {
        color: red;
        padding: 10px 5px;
            ...
            <div class="flex flex-col items-center justify-center flex-1 w-full box-border" style="padding: 0 10% 2rem;">
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="relative login-group mt-5">
                        ...
                        <label class="absolute bg-white transition-a8l duration-100 scale-0 -top-1 left-4 text-[10px] px-1 login-group__label">
                            Password
                        </label>
                    </div>
                    <div class="relative text-right mt-3.5">
                        <a href="<?= \App\Utils\SitesPage::getFirstPageUrlByTemplate('vip_admin/reset-password'); ?>" class="text-black leading-7 no-underline transition-all duration-150 inline-block hover:text-admin-primary">
                            Forgot Password?
                        </a>
                    </div>
                    <div class="relative mt-3.5">
                        <?= $this->Form->button(__('Sign in'), ['class' => 'btn-glow w-full']); ?>
                    </div>
