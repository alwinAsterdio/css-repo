...
<?= $this->Html->css('/vip_portal/css/vip_admin/tw-matching-properties'); ?>
...
<script>
    ...
    function addClassToCircleIndicator() {
        document.getElementById("circle_indicator_mymatchingproperties").classList.add("circle_indicator_active");
    }
