document.addEventListener('DOMContentLoaded', function(event) {
    Wishlist.enable({
        load_dummy_template: function(id) {
            return `<a href='' class="property-item loading-wishlist-item" id="${id}" data-sale-rent="">
                <div class="property-item__inner">
                    <div class="property-item__inner__row1">
                        ...
                        <span class="property-item__inner__row1__sale-rent"></span>
                    ...
                    <div class="property-item__inner__row2">
                        <div class="property-item__inner__row2__details">
                            <div class="property-item__inner__row2__details__row1">
                                <div class="property-item__inner__row2__details__row1__price">&nbsp;</div>
                                <div class="property-item__inner__row2__details__row1__ref"># <span>&nbsp;</span></div>
                            </div>
                            <div class="property-item__inner__row2__details__name">&nbsp;</div>
                            <div class="property-item__inner__row2__details__address">-</div>
                        </div>
        ...
        load_property_template: function(property) {
            ...
            property.features_short.map(feature => {
                let field_value = feature.value;
                if (field_value === '') {
                    field_value = '-'
                }
                features_html += `<div class="features-short__group">
                    <label class="features-short__group__label">${feature.label}<span class="features-short__group__label__prefix"></span></label>
            ...
            property_elem.querySelector('.property-item__inner__row1__img').innerHTML = `<img class="absolute top-0 left-0 object-cover w-full h-full transition-opacity duration-500 opacity-100 cursor-pointer" src="${property.featured_photo}" alt="property-image" loading="lazy"/>`
            property_elem.querySelector('.property-item__inner__row2__details__name').innerHTML = property.name
            property_elem.querySelector('.property-item__inner__row2__details__address').innerHTML = property.address
            property_elem.querySelector('.property-item__inner__row2__details__row1__price').innerHTML = property.website_price
            property_elem.querySelector('.property-item__inner__row1__sale-rent').innerHTML = property.sale_rent_display
            property_elem.querySelector('.property-item__inner__row2__features .features-short').innerHTML = features_html
            property_elem.querySelector('.property-item__inner__row2__details__row1__ref > span').innerHTML = property.ref
