...
<?= $this->Html->css('/mansion/css/tw-wishlist'); ?>
...
<div class="bg-white">
    <div class='px-5 md:px-10 2xl:px-12 py-10 max-w-[1600px] mx-auto'>
        <div class="font-[Jaldi] font-extralight text-3xl text-center mb-10"><?= $page_data_options['section_title'] ?></div>
...
<?= $this->html->script('/mansion/js/wishlist.js'); ?>
