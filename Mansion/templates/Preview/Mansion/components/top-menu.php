...
<div class="absolute top-0">
    <div class='menu-section' id="nav-menu">
        <div class="box-border flex justify-center items-center px-4 md:px-6 xl:px-10 2xl:px-12 py-1 text-sm uppercase xl:text-base !leading-4 menu-bar">
            <div class="flex flex-row gap-2 items-center w-full">
                <?php foreach ($menu_list as $item) : ?>
                    ...
                    ?>
                <?php endforeach; ?>
                <div class="menu-section__col flex-1 flex justify-start items-center">
                ...
                <div class="menu-section__col flex-1 gap-10 flex justify-center items-center"><?= $nav_menu_center_html ?></div>
                <div class="menu-section__col flex-1 gap-10 flex justify-end items-center">
