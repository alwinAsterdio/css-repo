        ...
        <div class="property-item__inner__row2">
            <div class="property-item__inner__row2__details">
                <div class="property-item__inner__row2__details__row1">
                    <div class="property-item__inner__row2__details__row1__price"><?= $property->getWebsitePrice(['default_value' => '--']) ?></div>
                    <div class="property-item__inner__row2__details__row1__ref">Ref: <?= $property->getField('ref') ?></div>
                </div>
