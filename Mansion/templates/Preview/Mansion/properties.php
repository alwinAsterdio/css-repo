...
<?= $this->Html->css('/mansion/css/tw-properties'); ?>
...
<div class='bg-white px-5 md:px-10 2xl:px-12 py-5 md:py-10 properties-listing-section'>
    <?php if (!empty($property_data['data'])) : ?>
        <div class="qcf-container inline-labels flex flex-wrap m-mobile:flex-row md:items-center gap-5">
            ...
            <div class="flex-1 order-1 m-mobile:order-2 md:order-3 inline-flex justify-end gap-2 items-center hover:cursor-pointer view-map-btn">
                <span class="text-lg inline-block border border-solid border-[#8e8e8e] px-[20px] py-[4px] rounded-[50px] text-[#8e8e8e] hover:border-theme-primary-color hover:text-theme-primary-color transition-colors">MAP</span>
            </div>
        </div>
...
<?= $this->html->script('/mansion/js/properties.js'); ?>
