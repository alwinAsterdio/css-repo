...
$options = [
    ...
    [
        ...
        'page_type' => 'project',
        'options' => [
            'primary_section_image' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/home-main-image.webp'),
            'info_array' => [
                'info_title' => [
                    'a1' => 'Perfect',
                    'a2' => 'Convenient',
                ...
                'info_description' => [
                    'a1' => '<p>for living and</p><p>investing<p>',
                    'a2' => '<p>access to essential</p><p>amenities</p>',
                    'a3' => '<p>by a reputable real</p><p>estate developer</p>',
                ],
            ],
            'features_array' => [
                'feature_img' => [
                    'a1' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/modern-design.webp'),
                    'a2' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/window-icon.webp'),
                    'a3' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/smarthome-icon.webp'),
                    'a4' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/floor-icon.webp'),
                    'a5' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/security-icon.webp'),
                    'a6' => new \App\Utils\MediaUpload(\Cake\Core\Plugin::path('Sothebys') . 'webroot/images/default/parking-icon.webp'),
                ],
                'feature_title' => [
                    'a1' => 'Modern design',
                    'a2' => 'Windows',
                ...
                'feature_description' => [
                    'a1' => '<p>Sleek, minimalist, and spacious with natural light in modern apartment design<p>',
                    'a2' => '<p>Energy-efficient, durable, and thermally insulated aluminum windows</p>',
                    'a3' => '<p>Efficient, interconnected, user-friendly, and innovative smart home systems</p>',
                    'a4' => '<p>Elegantly polished, luxuriously smooth, and exquisitely crafted marble floors</p>',
                    'a5' => '<p>Reliable, high-definition, and comprehensive surveillance through a functional CCTV system</p>',
                    'a6' => '<p>Each apartment includes dedicated parking and a storage room</p>',
                ],
            ],
