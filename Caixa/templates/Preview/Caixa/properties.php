...
<?= $this->Html->css('/caixa/css/tw-properties'); ?>
<?php
...
if (empty($search_params['sort'])) {
    $search_params['sort'] = $sale_rent !== 'for_sale' ? 'caixa_relevance_for_rent' : 'caixa_relevance_for_sale';
}

$saved_search_flag = false;
if (!empty($search_params['ssf'])) {
    $saved_search_flag = true;
    unset($search_params['ssf']);
}
...
$page_subcategory2 = \Caixa\Utils\Caixa::getCaixaSaleRentValue($sale_rent);
...
if (array_key_exists($tab, $tab_mapping)) {
    [
        $page_subcategory1,
        $page_type,
    ] = $tab_mapping[$tab];
...
<div class="top-menu-padding">
    <div class="l-breadcrumb-section container-section" data-search-source="locations"></div>
    <div class="bg-[#FAFAF9]">
        <div class="container-section">
    <h1 class="my-0 l-pagination-header"><?= \App\Utils\CommonFunctions::getListingPageTitle($query_params, $property_data, ['property_type_default' => 'casas y pisos', 'sale_rent_text_rent' => 'en alquiler', 'sale_rent_text_sale' => '', 'in_text' => 'en', 'and_text' => 'y', 'duplex_text' => 'dúplex']) ?></h1>
    <div class="pb-10 save-search-btn <?= empty($token) ? 'save-search-btn--no-token' : 'save-search-btn--ready' ?> save-search-btn--sm <?= $saved_search_flag ? 'save-search-btn--loaded' : '' ?>">
        <div class="save-search-btn__content save-search-btn__content--ready">
            <div>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.009 12.6303C9.7855 13.818 8.80759 14.3644 7.99544 14.3648C7.22843 14.3648 6.22561 13.8654 5.98222 12.6303H5.83741C4.99962 12.6303 4.16147 12.6318 3.32368 12.6299C2.64153 12.6281 2.16558 12.0976 2.23889 11.4195C2.26886 11.1423 2.40284 10.9161 2.61842 10.7417C2.75492 10.6313 2.89323 10.5217 3.03876 10.424C3.29985 10.2488 3.43093 10.0045 3.48005 9.69804C3.67577 8.47527 3.84658 7.24743 4.08672 6.03334C4.37886 4.55617 5.2701 3.55595 6.67484 3.02291C6.80123 2.97478 6.83987 2.9234 6.84095 2.78806C6.84673 2.14646 7.36638 1.63477 7.9958 1.63477C8.62631 1.63477 9.14451 2.14428 9.15101 2.78733C9.15246 2.92412 9.19326 2.9737 9.31857 3.02219C10.7934 3.59033 11.6749 4.65569 11.9424 6.21935C12.1255 7.28904 12.2981 8.36019 12.4755 9.43098C12.482 9.47114 12.4885 9.51131 12.4906 9.55184C12.5159 9.98754 12.7228 10.3085 13.0958 10.5296C13.1807 10.5799 13.2558 10.6465 13.3335 10.708C13.7199 11.0142 13.8611 11.4712 13.7065 11.9138C13.5527 12.3556 13.158 12.6299 12.6679 12.6307C11.8301 12.6321 10.992 12.631 10.1542 12.631H10.0094L10.009 12.6303ZM7.98786 12.0401C9.55149 12.0401 11.1148 12.0401 12.6784 12.0401C12.9153 12.0401 13.0922 11.9189 13.1583 11.7177C13.2262 11.5114 13.1612 11.3131 12.9742 11.1683C12.8283 11.0551 12.6788 10.9461 12.5314 10.8347C12.2021 10.5861 12.0143 10.2539 11.9475 9.84858C11.75 8.64426 11.5514 7.43995 11.3535 6.23599C11.0877 4.61878 9.76238 3.43111 8.12581 3.38841C6.70409 3.3515 5.64783 3.98803 4.96207 5.23541C4.73059 5.65663 4.65151 6.12345 4.57748 6.59244C4.41498 7.6198 4.23044 8.64426 4.07769 9.67307C3.99825 10.2086 3.78338 10.6411 3.32404 10.9404C3.21101 11.0138 3.10412 11.0978 3.00012 11.1839C2.85062 11.3077 2.77659 11.4651 2.82245 11.6623C2.87951 11.9087 3.05429 12.0404 3.32513 12.0408C4.87973 12.0415 6.43398 12.0408 7.98858 12.0408L7.98786 12.0401ZM6.59937 12.6365C6.70373 13.2759 7.31293 13.7724 7.9893 13.7742C8.67506 13.776 9.28463 13.2842 9.39296 12.6365H6.59937ZM8.54687 2.81086C8.5902 2.66213 8.50751 2.46527 8.33959 2.33752C8.15722 2.19893 7.90516 2.18481 7.70583 2.30242C7.51335 2.41605 7.40899 2.61942 7.44113 2.81086H8.54687Z" fill="white" stroke="white" stroke-width="0.3"/>
                </svg>
            </div>
            <div><?= $page_data_options['saved_search_lbl'] ?></div>
        </div>
    </div>
        <div class="flex box-border xl:gap-[24px]">
            <div class="box-border relative pb-2 border-0 border-b border-solid filters-col search-menu xl:basis-1/5 bg-theme-tertiary-color border-b-gray-300">
                <div class="save-search-btn <?= empty($token) ? 'save-search-btn--no-token' : 'save-search-btn--ready' ?> save-search-btn--lg <?= $saved_search_flag ? 'save-search-btn--loaded' : '' ?>">
                    <div class="save-search-btn__content save-search-btn__content--ready">
                        <div>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.009 12.6303C9.7855 13.818 8.80759 14.3644 7.99544 14.3648C7.22843 14.3648 6.22561 13.8654 5.98222 12.6303H5.83741C4.99962 12.6303 4.16147 12.6318 3.32368 12.6299C2.64153 12.6281 2.16558 12.0976 2.23889 11.4195C2.26886 11.1423 2.40284 10.9161 2.61842 10.7417C2.75492 10.6313 2.89323 10.5217 3.03876 10.424C3.29985 10.2488 3.43093 10.0045 3.48005 9.69804C3.67577 8.47527 3.84658 7.24743 4.08672 6.03334C4.37886 4.55617 5.2701 3.55595 6.67484 3.02291C6.80123 2.97478 6.83987 2.9234 6.84095 2.78806C6.84673 2.14646 7.36638 1.63477 7.9958 1.63477C8.62631 1.63477 9.14451 2.14428 9.15101 2.78733C9.15246 2.92412 9.19326 2.9737 9.31857 3.02219C10.7934 3.59033 11.6749 4.65569 11.9424 6.21935C12.1255 7.28904 12.2981 8.36019 12.4755 9.43098C12.482 9.47114 12.4885 9.51131 12.4906 9.55184C12.5159 9.98754 12.7228 10.3085 13.0958 10.5296C13.1807 10.5799 13.2558 10.6465 13.3335 10.708C13.7199 11.0142 13.8611 11.4712 13.7065 11.9138C13.5527 12.3556 13.158 12.6299 12.6679 12.6307C11.8301 12.6321 10.992 12.631 10.1542 12.631H10.0094L10.009 12.6303ZM7.98786 12.0401C9.55149 12.0401 11.1148 12.0401 12.6784 12.0401C12.9153 12.0401 13.0922 11.9189 13.1583 11.7177C13.2262 11.5114 13.1612 11.3131 12.9742 11.1683C12.8283 11.0551 12.6788 10.9461 12.5314 10.8347C12.2021 10.5861 12.0143 10.2539 11.9475 9.84858C11.75 8.64426 11.5514 7.43995 11.3535 6.23599C11.0877 4.61878 9.76238 3.43111 8.12581 3.38841C6.70409 3.3515 5.64783 3.98803 4.96207 5.23541C4.73059 5.65663 4.65151 6.12345 4.57748 6.59244C4.41498 7.6198 4.23044 8.64426 4.07769 9.67307C3.99825 10.2086 3.78338 10.6411 3.32404 10.9404C3.21101 11.0138 3.10412 11.0978 3.00012 11.1839C2.85062 11.3077 2.77659 11.4651 2.82245 11.6623C2.87951 11.9087 3.05429 12.0404 3.32513 12.0408C4.87973 12.0415 6.43398 12.0408 7.98858 12.0408L7.98786 12.0401ZM6.59937 12.6365C6.70373 13.2759 7.31293 13.7724 7.9893 13.7742C8.67506 13.776 9.28463 13.2842 9.39296 12.6365H6.59937ZM8.54687 2.81086C8.5902 2.66213 8.50751 2.46527 8.33959 2.33752C8.15722 2.19893 7.90516 2.18481 7.70583 2.30242C7.51335 2.41605 7.40899 2.61942 7.44113 2.81086H8.54687Z" fill="white" stroke="white" stroke-width="0.3"/>
                    ...
                    <div class="save-search-btn__content save-search-btn__content--saved">
                        <div>
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="24" height="24" rx="12" fill="#BDC3FF"/>
                                <path d="M17.793 9L11.2152 15.5778C10.7573 16.0142 10.0375 16.0142 9.57962 15.5778L6.66406 12.6978" stroke="#003C46" stroke-width="1.5" stroke-linecap="round"/>
                            </svg>
                        </div>
                        <div>
                            <div><?= $page_data_options['saved_search_after_save_lbl'] ?></div>
                            <div>
                                <a href="/<?= \App\Utils\SitesPage::getFirstPageSlugByTemplate('saved_searches'); ?>"><?= $page_data_options['saved_search_see_all_lbl'] ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                <?php echo \App\Utils\Search::render('caixa', ['action' => '/' . \App\Utils\SitesPage::getFirstPageSlugByTemplate('properties'),'style' => 'listing-filters rounded-[8px] border-b border-[#E8E7E1] border-opacity-100', 'row_class' => '', 'mobile_filter' => true]); ?>
            </div>
            <div class="p-listing">
                <div class="p-listing__sale-rent-tabs">
                    <div class="p-listing__sale-rent-tabs__item <?= $sale_rent === 'for_sale' ? 'p-listing__sale-rent-tabs__item--active' : '' ?>" data-value="for_sale">Comprar</div>
                    <div class="p-listing__sale-rent-tabs__item <?= $sale_rent === 'for_rent' ? 'p-listing__sale-rent-tabs__item--active' : '' ?>" data-value="for_rent">Alquilar</div>
                ...
                <div class="content-results">
                    <div class="p-listing__actions">
                        <div class="filter-mobile-btn">
                            ...
                            <div class="inline-flex whitespace-nowrap">
                                Filtros (<span class="filter-mobile-btn__counter">0</span>)
                            </div>
                        </div>
                        <div class="flex flex-row flex-wrap gap-[10px] p-listing__actions__pagination inline-labels md:items-center flex-1 sort_by_container">
                            ...
                            $field_details = [
                                ...
                                'size' => 'small',
                                'label' => 'Sort By',
                                'default' => $search_params['sort'],
                                'options' => [
                                    $sale_rent !== 'for_sale' ? 'caixa_relevance_for_rent' : 'caixa_relevance_for_sale' => 'Relevancia',
                                    '-website_listing_date' => 'Más recientes', // Recently Added
                                    'price_asc' => 'Precio ascendente', // Price: Low to High
                                    'price_desc' => 'Precio descendente', // Price: High to Low
                                    '-internal_area_amount' => 'Más superfície', // Size: Low to High
                                    'internal_area_amount' => 'Menos superfície', // Size: High to Low
                                    'price_per_square' => 'Más baratos €/m²', // Price per m²: Low to High
                                    '-price_per_square' => 'Más caros €/m²', // Price per m²: High to Low
                                ],
                                'class' => 'sort-manual',
                            ];

                            ?>
                            <div class="hidden xl:inline-flex text-base font-[Roboto] leading-[20.8px] text-[#333333]">
                                Ordenar por:
                            </div>
                    ...
                    <div class="p-listing__results p-listing <?= empty($property_data['data']) ? 'hidden' : '' ?>">
                        <div id="section-listing-1" class='grid grid-cols-1 gap-6 p-listing__results__section p-listing__results__section--active md:gap-[24px]'>
                            ...
                            foreach ($property_data['data'] as $property) :
                                echo $this->element('property-list-item', ['property' => $property]);
                            endforeach;
                            ?>
                        </div>
                        <div id="section-listing-2" class='grid grid-cols-1 gap-6 md:grid-cols-2 p-listing__results__section md:gap-8'>
                            <?php
                            foreach ($property_data['data'] as $property) :
                                echo $this->element('property-item', ['property' => $property]);
                            endforeach;
                            ?>
                        </div>
                    ...
                    <div class="no-results-section <?= empty($property_data['data']) ? 'no-results-section--active' : '' ?>">
                        ...
                        <div class="pt-8 text-2xl font-medium text-theme-primary-color">Ups, no hemos encontrado lo que buscas</div>
                        <div class="pb-8 text-lg">Prueba a ampliar tu búsqueda modificando algún filtro</div>
                        <div><button class="btn btn-primary btn-pill reset-filters">Limpiar filtros</button></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        <?php if (empty($property_data['data'])) : ?>
            if (typeof TealiumTracker !== 'undefined') {
                const tealium_object_no_results = new TealiumTracker();
                tealium_object_no_results.trackEvent({
                    "events": "pageview",
                    "page_subcategory1": "filtro sin resultados",
...
<?php endif; ?>
<script>
    const saved_search_url = '<?= \App\Utils\SitesPage::getFirstPageSlugByTemplate('saved_searches'); ?>'
...
<?= $this->html->script('/caixa/js/properties.js'); ?>
