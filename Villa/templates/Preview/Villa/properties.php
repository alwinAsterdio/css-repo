...
<?= $this->Html->css('/Villa/css/tw-properties'); ?>
<?php include __DIR__ . '/components/top-menu.php' ?>
<div class="search-menu pt-[150px] bg-[var(--theme-background-color-1)] pb-10 border-0 border-b border-solid border-b-gray-300">
...
?>
<div class='bg-white px-5 md:px-10 2xl:px-12 py-10 properties-listing-section'>
    <?php if (!empty($property_data['data'])) : ?>
        <div class="qcf-container inline-labels flex flex-wrap m-mobile:flex-row flex-col md:items-center gap-5">
            ...
            <div class="flex-1 order-3 md:order-2">
...
<?= $this->html->script('/Villa/js/properties.js'); ?>
