document.addEventListener('DOMContentLoaded', function(event) {
    Wishlist.enable({
                ...
                <div class="property-item__inner">
                    ...
                    <div class="property-item__inner__row2">
                        <div class="property-item__inner__row2__details">
                            <span class="property-item__inner__row2__ref">Ref: <span>&nbsp;</span></span>
        ...
        load_property_template: function(property) {
            ...
            property_elem.querySelector('.property-item__inner__row2__details__price').innerHTML = property.website_price
            ...
            property_elem.querySelector('.property-item__inner__row2__ref > span').innerHTML = property.ref
