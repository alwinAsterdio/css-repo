...
<?= $this->Html->css('/Penthouse/css/tw-list_a_property'); ?>
    ...
    <div class="xl:max-w-[1000px] xl:mx-auto gap-10 px-10 md:px-20 py-10 cookies-section">
        ...
        <div class="form">
            <form id="list-property-form" action="" class="enquiry-form grid grid-cols-6 gap-4" integration-recaptcha=true data-action="lead_form">
                ...
                <div class="form-group col-span-3">
                    <input type="text" class="bg-[#f6f6f4] w-full border border-solid border-[#A19E99] border-opacity-50 px-3 py-3.5 box-border" name="options[extra][property_type]" id="property_type" placeholder="<?= $page_data_options['contact_form_property_type'] ?>">
                    <div class="form-group__helper"></div>
                </div>
                <div class="form-group col-span-2">
                    <input type="text" class="bg-[#f6f6f4] w-full border border-solid border-[#A19E99] border-opacity-50 px-3 py-3.5 box-border" name="options[extra][location]" id="location" placeholder="<?= $page_data_options['contact_form_location'] ?>">
                    <div class="form-group__helper"></div>
                </div>
                <div class="form-group col-span-2">
                    <input type="text" class="bg-[#f6f6f4] w-full border border-solid border-[#A19E99] border-opacity-50 px-3 py-3.5 box-border" name="options[extra][covered_area]" id="covered_area" placeholder="<?= $page_data_options['contact_form_covered_area'] ?>">
                    <div class="form-group__helper"></div>
                </div>
                <div class="form-group col-span-2">
                    <input type="text" class="bg-[#f6f6f4] w-full border border-solid border-[#A19E99] border-opacity-50 px-3 py-3.5 box-border" name="options[extra][plot_size]" id="plot_size" placeholder="<?= $page_data_options['contact_form_plot_size'] ?>">
                    <div class="form-group__helper"></div>
                </div>
                <div class="form-group col-span-6">
                    <textarea id="message" name="message" cols="30" rows="10" class="bg-[#f6f6f4] w-full border border-solid border-[#A19E99] border-opacity-50 px-3 py-3.5 box-border required-field" placeholder="<?= $page_data_options['contact_form_message'] ?>"></textarea>
                    <div class="form-group__helper"></div>
                </div>
