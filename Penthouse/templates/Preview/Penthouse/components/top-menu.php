...
<div class="absolute top-0">
    <div class='menu-section' id="nav-menu">
        <div class="box-border flex justify-between items-center px-4 md:px-6 xl:px-10 2xl:px-12 py-1 text-sm uppercase xl:text-base !leading-4 menu-bar">
            ...
            <div class="flex flex-col xl:justify-end items-end">
                ...
                <div class="flex lg:hidden items-center justify-center gap-2">
                    ...
                    <div class="flex lg:hidden mr-2 md:mr-3 menu-mobile-toggle">
                        <svg width="15" height="13" viewBox="0 0 15 13" fill="none" class="w-6 h-4 fill-white stroke-theme-tertiary-color menu-mobile-toggle__btn" xmlns="http://www.w3.org/2000/svg">
                            <g id="Group 1">
