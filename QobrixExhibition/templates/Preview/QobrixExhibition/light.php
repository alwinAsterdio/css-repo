...
<?= $this->Html->css('/QobrixExhibition/css/tw-light'); ?>
...
<div>
  ...
  <div class="px-6 py-16 lg:py-24">
    <div class="container max-w-screen-xl m-auto">
      <div class="text-center m-auto max-w-2xl">
        <div class="border border-solid border-slate-300 p-5 lg:p-10 bg-white rounded-xl text-left">
  ...
  <div class="px-6">
    <div class="container max-w-screen-xl m-auto">
      <div class="pb-20 text-center text-slate-700">
        &copy; Copyright
        <script>
  ...
  <!-- Background -->
  <div class="fixed top-0 inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,var(--theme-primary-color))]">
  </div>
  <!-- End Background -->
