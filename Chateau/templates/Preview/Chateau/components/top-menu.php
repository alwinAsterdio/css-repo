...
<div class="absolute top-0">
    <div class='menu-section' id="nav-menu">
        <div class="box-border flex justify-between items-center px-4 md:px-6 xl:px-10 2xl:px-12 py-1 overflow-x-hidden text-sm uppercase xl:text-base !leading-4 menu-bar">
