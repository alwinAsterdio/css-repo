...
<?= $this->Html->css('/chateau/css/tw-properties'); ?>
...
<div class="text-center mt-10">
    <div class="text-base font-light mb-1 font-JuliusSansOne"><?= $page_data_options['primary_section_sub_title'] ?></div>
    <div class="text-3xl font-extralight font-JuliusSansOne"><?= $page_data_options['primary_section_title'] ?></div>
</div>
<div class='px-5 md:px-10 2xl:px-12 max-w-[1600px] mx-auto py-10'>
    <?php if (!empty($property_data['data'])) : ?>
        <div class="qcf-container inline-labels flex flex-wrap flex-row md:items-center gap-5 pb-5">
            <?php
                $field_details = [
                    'id' => 'sort',
                    'name' => 'sort',
            ...
            <div class="flex-1 order-3 md:order-2 text-base font-extralight">
                <?= $property_data['pagination']['paginationInfo'] ?>
            </div>
            <div class="order-2 md:order-3 inline-flex justify-center gap-2 items-center hover:cursor-pointer view-map-btn">
...
<?= $this->html->script('/chateau/js/properties.js'); ?>
